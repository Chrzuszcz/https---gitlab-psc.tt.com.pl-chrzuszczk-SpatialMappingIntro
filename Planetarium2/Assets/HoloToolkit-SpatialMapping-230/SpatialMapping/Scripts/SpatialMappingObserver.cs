...
namespace Academy.HoloToolkit.Unity
{
    ...
    public class SpatialMappingObserver : SpatialMappingSource
    {
        ...
        public float TrianglesPerCubicMeter = 2000f;
        ...
        private void Update()
        {
          //  Debug.Log("SMO.Update(), ObserverState="+ ObserverState);
...
///XX UWAGA! XX dziwny typ Unity
            SurfaceObserver.SurfaceDataReadyDelegate dataReady = DataReady;
            //https://docs.unity3d.com/ScriptReference/VR.WSA.SurfaceObserver.SurfaceDataReadyDelegate.html
            if (dataReady != null)
            {
