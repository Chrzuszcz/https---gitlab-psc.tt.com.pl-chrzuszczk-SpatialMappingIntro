...
namespace Academy.HoloToolkit.Unity
{
    ...
    public class SurfaceMeshesToPlanes : Singleton<SurfaceMeshesToPlanes>
    {
        ...
        /// <summary>
        /// TT NOTE: help function for re-scaning enviornment
        /// </summary>
        /// <param name="_value"></param>
        public void changeMakingPlanesFlag(bool _value)
        {
            makingPlanes = _value;
        ...
        {
            Debug.Log("makingPlanes=" + makingPlanes);
            if (!makingPlanes)
            {
                makingPlanes = true;
        ...
        public List<GameObject> GetActivePlanes(PlaneTypes planeTypes)
        {
            ...
            foreach (GameObject plane in ActivePlanes)
            {
                ...
                {
                    //note TT : wyliczenie (enumeration)
